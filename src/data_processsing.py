...
import pandas as pd
import numpy as np
import joblib # for storing the result
...
class DataProcessor:
    def __init__(self, input_file, output_dir):
        self.input_file = input_file # file address ข้อมูลต้นฉบับที่จะนำมาประมวลผล
        self.output_dir = output_dir # file address for storing result
    ...
    # for process anime.csv and anime_with_synopsis.csv
