...
class ModelTraining:
    def __init__(self, data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key="HrWi65AkWfBzNiyDyH2NvxCMt",
            project_name="anime-recommender",
            workspace="gaoweichang"
        )
    ...
    def train_model(self):
        try:
            ...
            try:
                ...
                # บันทึกค่า loss ของการฝึกและการทดสอบในแต่ละ epoch in comet ml
    ...
    def save_model_weights(self,model):
        try:
            ...
            # อัพโหลดไฟล์โมเดลและ weights ไปเก็บบน Comet ML
